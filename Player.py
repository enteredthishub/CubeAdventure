        ...
        if self.control_type == Player.CONTROL_TYPE_KEYBOARD:
            for event in events:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    bullet = Bullet(bullet_x=self.player_x, bullet_y=self.player_y, bullet_target_x=mouse[0], bullet_target_y=mouse[1], bullet_speed=2, bullet_color=self.player_color)
