...
class ShotgunTheWeapon(Weapon):
    ...
    def shoot(self, weapon_target_x, weapon_target_y):
        ...
        bullet = Bullet(bullet_originator=self.player, bullet_x=self.player.player_x, bullet_y=self.player.player_y, bullet_target_x=weapon_target_x, bullet_target_y=weapon_target_y, bullet_speed=self.weapon_bullet_speed, bullet_color=(10, 0, 255), bullet_radius=3)
        self.spawn_bullet(bullet)
        bullet = Bullet(bullet_originator=self.player, bullet_x=self.player.player_x, bullet_y=self.player.player_y, bullet_target_x=weapon_target_x + 30, bullet_target_y=weapon_target_y + 30, bullet_speed=self.weapon_bullet_speed, bullet_color=(10, 0, 255), bullet_radius=3)
        self.spawn_bullet(bullet)
        bullet = Bullet(bullet_originator=self.player, bullet_x=self.player.player_x, bullet_y=self.player.player_y, bullet_target_x=weapon_target_x - 30, bullet_target_y=weapon_target_y - 30,bullet_speed=self.weapon_bullet_speed, bullet_color=(10, 0, 255), bullet_radius=3)
        self.spawn_bullet(bullet)
        bullet = Bullet(bullet_originator=self.player, bullet_x=self.player.player_x, bullet_y=self.player.player_y, bullet_target_x=weapon_target_x + 60, bullet_target_y=weapon_target_y + 60,bullet_speed=self.weapon_bullet_speed, bullet_color=(10, 0, 255), bullet_radius=3)
        self.spawn_bullet(bullet)
        bullet = Bullet(bullet_originator=self.player, bullet_x=self.player.player_x, bullet_y=self.player.player_y, bullet_target_x=weapon_target_x - 60, bullet_target_y=weapon_target_y - 60,bullet_speed=self.weapon_bullet_speed, bullet_color=(10, 0, 255), bullet_radius=3)
        self.spawn_bullet(bullet)
